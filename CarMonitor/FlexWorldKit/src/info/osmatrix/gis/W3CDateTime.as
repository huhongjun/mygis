...
package info.osmatrix.gis
{
	class W3CDateTime
	{
	    ...
	    public function setDateTimeString(dateString:String):void
	    {
	        ...
	        date.setTime(W3CDateTime.parseString(dateString).getTime());		
	    }
	...
	Note, that all output will be a valid W3CDataTime item.
	    ...
	    {
	        return W3CDateTime.parseDate(date, incMonth, incDay, incHours, incSeconds);
	    }    
	    ...
	    {
	        return W3CDateTime.formatTimezoneOffset(date);
	    }	
