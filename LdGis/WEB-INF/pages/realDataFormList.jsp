...
<html:form  action="realControl.do?method=search" method="post" styleId="privateForm">
<vlh:root id="objectid" configName="microsoftLook" value="ldList" url="realControl.do?method=search&" includeParameters="*">

<vlh:paging showSummary="true"/>  
    <table width="1000" class="classicLook" cellspacing="0" cellpadding="0">
    	<c:if test="${ldList.valueListInfo.totalNumberOfEntries != 0}">
