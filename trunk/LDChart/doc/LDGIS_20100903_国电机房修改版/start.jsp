...
<script type="text/javascript" src="scripts/FlexChart.js"></script>
...
function StartDispStop1111(){

		if (timeDispStop!=null)	
			clearInterval(timeDispStop);	//清除原来的监控定时器
	
		delaytime = 5000;	//定时器的时间间隔是以毫秒计算的
//clearBuffers01();
		timeDispStop=setInterval("tdxs();",delaytime); 	//设置新的循环定时器

} 
function StopDispStop1111(){ 
	if (timeDispStop){	
		if (timeDispStop!=null)	
			clearInterval(timeDispStop);	//清除原来的监控定时器	
	}
...
<div id="panels">
	     ...
	     <div id="pc3" style="padding:6px;width:100%;height:450px;overflow:auto;overflow-x:hidden;display:none">
		    <form id="1" name="xlljcx" method="post"><table>
				...
				<tr><td colspan="2"><hr noshade style="border:1 dotted red" width="100%" size="1"></td></tr>
		   		...
		   		<tr >
					<td>线路名称</td><td><input type="text" name="xlmc" readonly="true" size=19></td>
				</tr>
		   		<tr >
		 	...
		 	<p align="center"><input type="button" value="图示结果" onclick="javascript:getLdxlData(tree,_el('xlljcx')); stopJK();">
				<input type="button" value="报表结果" onclick="javascript:getLdDataList('_blank',1,'editThunder.do','find')">
                <!--<input type="button" value="闪烁停电结果" onclick="javascript:StartDispStop()">
                <input type="button" value="停止闪烁" onclick="javascript:StopDispStop()">
                <input type="button" value="开始监控停电线路" onclick="javascript:StartTd()">
                <input type="button" value="停止监控停电线路" onclick="javascript:StopTd()"> -->
			</p>
		  </form>  
	    </div> 
	</div>
	...
	<div id="p2" class="panel1" style = "display:none" >
		<div id="p2t" style="background-color:#A418CE;" class="titlediv">
			<span style="float:right;">
				...
				<span onClick="_el('p2').style.display='none'; stopJK();">&#160;×&#160;</span>
			</span>
		...
		<div id="pc2" style="width:100%;height:80px;overflow:auto;overflow-x:hidden;display:none">
			<table>
				<tr><td>
			请选择实时监控时间间隔：<select id="jkSelect" size="1">
			  <option> </option>
			  <option>1</option>
			  <option>30</option>
			  <option>60</option>
		    ...
		    <p align="center"><input type="button" value="启动监控" id="JkButton" onclick="javascript:doJK()">
	...
	<div id="p3" class="panel1">
		...
		<form id="0" method="post"><table>
 		...
 		<td><select name="hfjg" size="1" style="display:none">
 			...
 			<p align="center"><input type="button" onclick="javascript:showHistoryOnMainView();stopJK();" value="图示结果" >
	...
	<div id="p1" class="panel1" style = "display:none" >
		...
		<form id="2" name ="zdycx" method="post">
		<table>
		...
		<!--</table>  -->
		<p align="center"><input name="showonpic" type="button" value="图示结果" onclick="javascript:playZdyLdDataList(2);stopJK();">
	...
	<div id="p6" class="panel1" style = "display:none" >
		...
		<p align="center"><input name="showonpicmd" type="button" value="图示结果" onclick="javascript:playLdMdData();stopJK();">
		</p>
