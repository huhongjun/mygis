// Author: Unregistered Demo Version/Creator: MapViewSVG Professional 6.2.11 for ArcGIS by uismedia (http://www.mapviewsvg.com); 2007-8-9 9:24:59
var SVGscalebar;
var theScalebarFlag = true;
var theMassGesamtLength = 60;
var theRectCount = 3;
...
var thePrecision = 3;
var theXOrigin = 98.75;
var theYOrigin = 201.25;
var maxScaleFakt = 20;
...
function embedHead() {
  if (OperaFlag()) {
    document.write('<div id="head"><object type="image/svg+xml" id="svgdocHead" data="embfiles/head.svg" width="737px" height="55px"><param name="src" value="embfiles/head.svg"></object></div>');
  } else {
    document.write('<div id="head"><embed type="image/svg+xml" id="svgdocHead" src="embfiles/head.svg" width="737px" height="55px"/></div>');
  }
}
...
function embedMap() {
  if (OperaFlag()) {
    document.write('<div id="map"><object type="image/svg+xml"  id="svgdocMap" data="embfiles/map.svg" width="498px" height="498px"><param name="src" value="embfiles/map.svg"></object></div>');
  } else {
    document.write('<div id="map"><embed type="image/svg+xml"  id="svgdocMap" src="embfiles/map.svg" width="498px" height="498px"/></div>');
  }
}
function embedOverview() {
  if (OperaFlag()) {
    document.write('<div id="overview"><object type="image/svg+xml"  id="svgdocOverview" data="embfiles/overview.svg" width="167px" height="167px"><param name="src" value="embfiles/overview.svg"></object></div>');
  } else {
    document.write('<div id="overview"><embed type="image/svg+xml"  id="svgdocOverview" src="embfiles/overview.svg" width="167px" height="167px"/></div>');
  }
}
