// Author: Unregistered Demo Version/Creator: MapViewSVG Professional 6.2.11 for ArcGIS by uismedia (http://www.mapviewsvg.com); 2007-8-9 9:45:53
var SVGscalebar;
...
function embedHead() {
  if (OperaFlag()) {
    document.write('<div id="head"><object type="image/svg+xml" id="svgdocHead" data="embfiles/head.svg" width="1270px" height="55px"><param name="src" value="embfiles/head.svg"></object></div>');
  } else {
    document.write('<div id="head"><embed type="image/svg+xml" id="svgdocHead" src="embfiles/head.svg" width="1270px" height="55px"/></div>');
  }
}
...
function embedMap() {
  if (OperaFlag()) {
    document.write('<div id="map"><object type="image/svg+xml"  id="svgdocMap" data="embfiles/map.svg" width="898px" height="898px"><param name="src" value="embfiles/map.svg"></object></div>');
  } else {
    document.write('<div id="map"><embed type="image/svg+xml"  id="svgdocMap" src="embfiles/map.svg" width="898px" height="898px"/></div>');
  }
}
function embedOverview() {
  if (OperaFlag()) {
    document.write('<div id="overview"><object type="image/svg+xml"  id="svgdocOverview" data="embfiles/overview.svg" width="300px" height="300px"><param name="src" value="embfiles/overview.svg"></object></div>');
  } else {
    document.write('<div id="overview"><embed type="image/svg+xml"  id="svgdocOverview" src="embfiles/overview.svg" width="300px" height="300px"/></div>');
  }
}
...
function embedScalebar() {
  if (OperaFlag()) {
    document.write('<div id="scalebar"><object type="image/svg+xml"  id="svgdocScalebar" data="embfiles/scalebar.svg" width="555px" height="35px"><param name="src" value="embfiles/scalebar.svg"></object></div>');
  } else {
    document.write('<div id="scalebar"><embed type="image/svg+xml"  id="svgdocScalebar" src="embfiles/scalebar.svg" width="555px" height="35px"/></div>');
  }
}
